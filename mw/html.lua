...
methodtable.wikitext = function( t, ... )
	for k,v in ipairs{...} do
		check_type_multi( k, v, { 'string', 'number' } )
		appendBuilder( t, v )
	end
	return t
end
...
methodtable.tag = function( t, tagName, args )
	check_type( 1, tagName, 'string' )
	check_type( 2, args, 'table', true )
	args = args or {}
...
methodtable.attr = function( t, name, val )
	...
	check_type( 1, name, 'string' )
	check_type_multi( 2, val, { 'string', 'number', 'nil' } )
...
methodtable.addClass = function( t, class )
	check_type_multi( 1, class, { 'string', 'number', 'nil' } )
...
methodtable.css = function( t, name, val )
	...
	check_type_multi( 1, name, { 'string', 'number' } )
	check_type_multi( 2, val, { 'string', 'number', 'nil' } )
...
methodtable.cssText = function( t, css )
	check_type_multi( 1, css, { 'string', 'number', 'nil' } )
...
function HtmlBuilder.create( tagName, args )
	check_type( 1, tagName, 'string', true )
	check_type( 2, args, 'table', true )
